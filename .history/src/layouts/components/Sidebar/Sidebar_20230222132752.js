      ...
      <div className={cx('sidebar-items')}>
        <div className={cx('sidebar-top')} onClick={handleOnClick}>
          <div className={cx('top-header')}>
            <NavLink className={cx('sibar-top-item')} to={config.routes.profile} style={{backgroundColor : clickItem ? 'rgb(57,49,66)' : 'AppWorkspace' }}>
              <MyZing />
          ...
          <div className={cx('top-bottom')}>
            ...
            <div className={cx('sidebar-advertisement')}>
              <form className={cx('sibar-login')} >
                ...
                <NavLink to='https://id.zalo.me' className={cx('btn-sibar-lg')}>ĐĂNG NHẬP</NavLink>
              </form>
