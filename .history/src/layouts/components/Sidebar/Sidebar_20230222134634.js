...
function Sidebar() {
  ...
  const [clickKhamPha, setClickKhamPha] = useState();
  const [clickZingChart, setClickZingChart] = useState();
  const [clickIRadio, setClickIRadio] = useState();
  const [clickFollowing, setClickFollowing] = useState();
  const [clickNewMusic, setClickNewMusic] = useState();
  const [clickCategory, setClickCategory] = useState();
  const [clickTopRank, setClickTopRank] = useState();
  const [clickMV, setClickMV] = useState();
