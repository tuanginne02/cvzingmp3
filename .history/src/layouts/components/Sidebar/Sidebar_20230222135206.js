...
function Sidebar() {
  ...
  const [clickKhamPha, setClicKKkKhamPha] = useState(false);
  ...
  const handleOnClickhamPha = () => setClicKKhamPha(false);
  const handleOnClickZingChart = () => setClickZingChart(false);
  const handleOnClickRadio = () => setClickRadio(false);
  const handleOnClickFollowing = () => setClickFollowing(false);
  const handleOnClickNewMusic = () => setClickNewMusic(false);
  const handleOnClickCategory = () => setClickCaNhan(false);
