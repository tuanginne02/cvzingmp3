...
function Sidebar() {
  ...
  const [clickIRadio, setClickIRadio] = useState(false);
  ...
  const [clickMV, setClickMV] = useState(false);


  const handleOnClickCaNhan = () => setClickCaNhan(false);
      ...
      <div className={cx('sidebar-items')}>
        <div className={cx('sidebar-top')} >
          <div className={cx('top-header')}>
            ...
            <NavLink className={cx('sibar-top-item')} to={config.routes.following}  style={{
                backgroundColor: clickCaNhan ? 'rgb(57,49,66)' : '',
                borderLeft: clickCaNhan ? '1px solid rgb(155,77,224) ' : '',
              }}>
              <Following />
          ...
          <div className={cx('top-bottom')}>
            ...
            <NavLink
              ...
              onMouseOut={handlOutMouseNewMusic}  style={{
                backgroundColor: clickCaNhan ? 'rgb(57,49,66)' : '',
                borderLeft: clickCaNhan ? '1px solid rgb(155,77,224) ' : '',
              }}
            >
            ...
            <NavLink to={config.routes.category} className={cx('sibar-top-item')}  style={{
                backgroundColor: clickCaNhan ? 'rgb(57,49,66)' : '',
                borderLeft: clickCaNhan ? '1px solid rgb(155,77,224) ' : '',
              }}>
              <CategoryMusic />
            ...
            <NavLink to={config.routes.toprank} className={cx('sibar-top-item')}  style={{
                backgroundColor: clickCaNhan ? 'rgb(57,49,66)' : '',
                borderLeft: clickCaNhan ? '1px solid rgb(155,77,224) ' : '',
              }}>
              <Top100 />
