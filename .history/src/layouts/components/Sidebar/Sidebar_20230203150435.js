      ...
      <div className={cx('sidebar-items')}>
        <div className={cx('sidebar-top')}>
          <div className={cx('top-header')}>
            ...
            <div className={cx('sibar-top-item')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
              <ZingChart />
              <p>#zingchart</p>
              <span>
                <FontAwesomeIcon
            ...
            <div className={cx('sibar-top-item')} >
              <Radio />
              <p>Radio</p>
              <div className={cx('live-primary')}  onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
                <span>LIVE</span>
              </div>
              <span>
                <FontAwesomeIcon className={cx('show-play', 'play-live')} icon={faCirclePlay}  style={{
                    display: changeOnMouse ? 'block' : 'none',
                  }}/>
              </span>
            </div>
