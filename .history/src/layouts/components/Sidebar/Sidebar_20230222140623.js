...
function Sidebar() {
  ...
  const [clickCaNhan, setClickCaNhan] = useState(false);
  ...
  const handleOnClickTopRank = () => {
    setClickTopRank(true);
    setClickCaNhan(false);
    setClickKhamPha(false);
    setClickZingChart(false);
    setClickRadio(false);
        ...
        <div className={cx('sidebar-top')}>
          <div className={cx('top-header')}>
            ...
            <NavLink
              ...
              onClick={handleOnClickZingChart}
            >
              <ZingChart />
              <p>#zingchart</p>
              <span>
            ...
            <NavLink
              ...
              onClick={handleOnClickFollowing}
            >
              <Following />
              <p>Theo Dõi</p>
            </NavLink>
