        ...
        <div className={cx('setting-items')}>
          ...
          <div className={cx('setting-item')}>
            ...
            <div className={cx('setting-icon-r')}>
             ...
             <div className={cx('setting-children')}>
              <div className={cx('children-item', 'sings-next')}>
                <div className={cx('children-item-top')}>
                <div className={cx('next-sings')}>
              ...
              <div className={cx('children-item', 'inp-nextSing')}>
               <input type='range' min='0' max='50' className={cx('next-inp')}/>
              </div>
            </div>
          </div>
        </div>
