            ...
            <div className={cx('dark-items')}>
              <div className={cx('dark-item')}>
                <div className={cx('dark-img')}>
                  <img className={cx('dar-img')} src="/imgtheme/th1.jpg" alt="" />
                  <p>Zing Music Awards</p>
                </div>
              </div>
              <div className={cx('dark-item')}>
                <div className={cx('dark-img')}>
                  <img className={cx('dar-img')} src="/imgtheme/th2.jpg" alt="" />
                  <p>XONE</p>
                </div>
              </div>
              <div className={cx('dark-item')}>
                <div className={cx('dark-img')}>
                  <img className={cx('dar-img')} src="/imgtheme/th3.jpg" alt="" />
                  <p>Tháp Eiffel</p>
                </div>
              </div>
              <div className={cx('dark-item')}>
            ...
            <div className={cx('light-items')}>
              <div className={cx('light-item')}>
                <div className={cx('light-img')}>
                  <img className={cx('lig-img')} src="/imgtheme/th1.jpg" alt="" />
                  <p>Zing Music Awards</p>
                </div>
              </div>
              <div className={cx('light-item')}>
                <div className={cx('light-img')}>
                  <img className={cx('lig-img')} src="/imgtheme/th2.jpg" alt="" />
                  <p>XONE</p>
                </div>
              </div>
              <div className={cx('light-item')}>
                <div className={cx('light-img')}>
                  <img className={cx('lig-img')} src="/imgtheme/th3.jpg" alt="" />
                  <p>Tháp Eiffel</p>
                </div>
              </div>
            </div>
