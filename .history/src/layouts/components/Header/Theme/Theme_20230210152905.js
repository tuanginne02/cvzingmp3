                ...
                <div className={cx('thems-items')}>
                    <div className={cx('thems-item')}>
                        <div className={cx('thems-img')}>
                            <img className={cx('the-img')} src='/imgtheme/dy1.png' alt='' />
                            <p>London</p>
                        </div>
                    </div>
                    <div className={cx('thems-item')}>
                        <div className={cx('thems-img')}>
                            <img className={cx('the-img')} src='/imgtheme/dy5.jpg' alt='' />
                            <p>Nâu</p>
                        </div>
                    </div>   <div className={cx('thems-item')}>
                        <div className={cx('thems-img')}>
                            <img className={cx('the-img')} src='/imgtheme/dy2.jpg' alt='' />
                            <p>Sáng Tối</p>
                        </div>
                    </div>   <div className={cx('thems-item')}>
                        <div className={cx('thems-img')}>
                            <img className={cx('the-img')} src='/imgtheme/dy3.jpg' alt='' />
                            <p>Xanh Da Trời</p>
                        </div>
                    </div>   <div className={cx('thems-item')}>
                        <div className={cx('thems-img')}>
                            <img className={cx('the-img')} src='/imgtheme/dy4.jpg' alt='' />
                            <p>Hồng</p>
                        </div>
                    </div>
                </div>
