...
function LoadMusic() {
  ...
  const ClickVolumOff = () => {setChangeVolum(0)}
  const ClickVolumOn = () => {setChangeVolum(50)}
      ...
      <div className={cx('loadMusic-content')}>
        ...
        <div className={cx('content-right')}>
          ...
          <div className={cx('icon-line-vl')}>
            <span className={cx('right-icon')}>
              <FontAwesomeIcon className={cx('right-vl')} icon={faVolumeHigh} style={{display: changeVolum ? 'block' : 'none',}}/>
              <FontAwesomeIcon className={cx('right-vl')} icon={faVolumeXmark} style={{display: changeVolum ? 'none' : 'block',}}  onClick={ClickVolumOff}/>
            </span>
            <div className={cx('line-volum')}>
              <input type="range" min="0" max={changeVolum} className={cx('run-volum')}/>
            </div>
          </div>
