...
function LoadMusic() {
  ...
  const [changeVolumOn, setChangeVolumOn] = useState(0);
  const [changeVolumOff, setChangeVolumOff] = useState(50);
        ...
        <div className={cx('content-right')}>
          ...
          <div className={cx('icon-line-vl')}>
            ...
            <div className={cx('line-volum')}>
              <input type="range" min={changeVolumOff} max={changeVolumOn} className={cx('run-volum')} />
            </div>
          </div>
