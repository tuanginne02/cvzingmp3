...
function LoadMusic() {
  ...
  const [playListMusic, setPlayListMusic] = useState(false);
  const playMusic = () => setPlayListMusic(true);
  const stopMusic = () => setPlayListMusic(false);
        ...
        <div className={cx('content-center')}>
          <div className={cx('center-top')}>
            ...
            <span className={cx('top-icon', 'play')}>
              ...
              />
              <FontAwesomeIcon className={cx('play-icon-pause')} icon={faPause} onClick={stopMusic} style={{display: playListMusic ? 'none' : 'block'}}/>
