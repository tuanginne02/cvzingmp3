    ...
    <div className={cx('loadMusic')}>
      <div className={cx('loadMusic-content')}>
        ...
        <div className={cx('content-right')}>
          ...
          <span className={cx('right-icon')}>
            <FontAwesomeIcon icon={faMicrophone} onClick={() => setShowLoadMusicBoard(!showLoadMusicBoard)} />
            {showLoadMusicBoard && <LoadMusicBoard style={{
        transform: hiddenLoadMusicBoard ? ' translateY(100%)' : 'translateY(0%) ',
        transition: hiddenLoadMusicBoard ? ' 1s ease-in 0.3s' : '1s ease-in 0.3s',
      }}/>}
          </span>
          <span className={cx('right-icon')}>
