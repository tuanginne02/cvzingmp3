...
import { faUpRightAndDownLeftFromCenter, faChevronDown, faGear } from '@fortawesome/free-solid-svg-icons';
...
function LoadMusicBoard() {
  ...
  return (
    ...
    >
      <div
        className={cx('loadMusic-board-conatiner')}
        style={{
          display: hiddenLoadMusicBoard ? ' block' : '',
        }}
      >
