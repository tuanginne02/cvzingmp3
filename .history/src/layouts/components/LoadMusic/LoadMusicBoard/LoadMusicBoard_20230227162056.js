...
function LoadMusicBoard() {
  ...
  return (
    <div className={cx('load-boars')}>
      <div className={cx('load-boars-conatiner')}>
      <div className={cx('content-boars')}>
          <div className={cx('boars-top')}>
            <span>Chúng Ta Không Thuộc Về Nhau</span>
            <span>-</span>
            <span>Sơn Tùng MT-P</span>
          </div>
          <div className={cx('boars-center')}>
          ...
          <div className={cx('boars-bottom')}>
            <span className={cx('boars-icon', 'shuffle')}>
              <span className={cx('boars-icon-shuffle')}>
                <FontAwesomeIcon icon={faShuffle} />
              </span>
            </span>
            <span className={cx('boars-icon')}>
              <span className={cx('boars-icon-backward')}>
            ...
            <span className={cx('boars-icon', 'play')}>
            ...
            <span className={cx('boars-icon')}>
              <span className={cx('boars-icon-forward')}>
                <FontAwesomeIcon icon={faForwardStep} />
              </span>
            </span>
            <span className={cx('boars-icon')}>
              <span className={cx('boars-icon-repeat')}>
