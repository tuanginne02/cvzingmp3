  ...
  return (
    <div classNam={cx('load-boars')}>
      ...
      <div className={cx('content-boars')}>
          ...
          <div className={cx('boars-top')}>
            <span className={cx('boarsicon', 'shuffle')}>
              <span className={cx('boarsicon-shuffle')}>
                <FontAwesomeIcon icon={faShuffle} />
              </span>
            </span>
            <span className={cx('boarsicon')}>
              <span className={cx('boarsicon-backward')}>
            ...
            <span className={cx('boarsicon', 'play')}>
            ...
            <span className={cx('boarsicon')}>
              <span className={cx('boarsicon-forward')}>
                <FontAwesomeIcon icon={faForwardStep} />
              </span>
            </span>
            <span className={cx('boarsicon')}>
              <span className={cx('boarsicon-repeat')}>
