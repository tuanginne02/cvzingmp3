...
function LoadMusic() {
  ...
  const [toggleBackgroundSt , setToggleBackgroundSt] = useState(true)
                  ...
                  <div className={cx('body-items')}>
                    <div className={cx('body-item')}>
                      ...
                      <div className={cx('item-icon')} onClick={toggleBgSt}>
                        <FontAwesomeIcon className={cx('st-icon')} icon={faToggleOn}  style ={{ display : toggleBackgroundSt ? 'block' : 'none'}}/>
