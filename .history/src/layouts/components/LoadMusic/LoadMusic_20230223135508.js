...
function LoadMusic() {
  ...
  const [pauseListMusic, setPauseListMusic] = useState(true);
  // const playMusic = () => setPlayListMusic(false);
  // const stopMusic = () => setPlayListMusic(true);
  const togglePlauMusic = () => setPlayListMusic((current)=>(!current));
  const toggleMusic = () => setPlayListMusic((current)=>(!current));
      ...
      <div className={cx('loadMusic-content')}>
        ...
        <div className={cx('content-center')}>
          <div className={cx('center-top')}>
            ...
            <span className={cx('top-icon', 'play')} onClick={toggleMusic}>
