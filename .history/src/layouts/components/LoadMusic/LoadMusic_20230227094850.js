      ...
      <div className={cx('loadMusic-content')}>
        ...
        <div className={cx('content-right')}>
          ...
          <div className={cx('icon-line-vl')}>
            <span className={cx('right-icon')}>
              <FontAwesomeIcon className={cx('right-vl')} icon={faVolumeHigh} style={{display: changeVolum }}/>
              <FontAwesomeIcon className={cx('right-vl')} icon={faVolumeXmark} style={{display: changeVolum }}/>
            </span>
