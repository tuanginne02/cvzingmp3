      ...
      >
        <div className={cx('board-header')}>
          ...
          <div className={cx('board-header-center')}>
            ...
            ')} style={{ backgroundColor: showPlayListBoard ? 'rgba(89, 84, 96, 0.8)' : 'transparent',
            color: showPlayListBoard ? '#ada4a4' : '#fff'
          }}>
              <span>Danh sách phát</span>
            </div>
            <div className={cx('header-center-items')} style={{ backgroundColor: showPlayListBoard ? 'rgba(89, 84, 96, 0.8)' : 'transparent',
            color: showKaraokeBoard ? '#ada4a4' : '#fff'
          }}>
              <span>Karaoke</span>
            </div>
            <div className={cx('header-center-items')} style={{ backgroundColor: showPlayListBoard ? 'transparent' : 'rgba(89, 84, 96, 0.8)',
