...
function LoadMusic() {
  ...
  const [showListSetting, setShowListSetting] = useState(true);
  const toggleSetting = () => setShowListSetting((current) => !current);
  const [toggleBackgroundSt, setToggleBackgroundSt] = useState(false);
  const [togglePlayMusicSt, setTogglePlayMusicSt] = useState(false);

  const toggleBgSt = () => setToggleBackgroundSt((current) => !current);
  const togglePMSt = () => setTogglePlayMusicSt((current) => !current);
      ...
      >
        <div className={cx('board-header')}>
          ...
          <div className={cx('board-header-right')}>
            ...
            <div className={cx('header-right-items')}>
              <FontAwesomeIcon icon={faGear} onClick={toggleSetting} />
              <div className={cx('right-items-list')} style={{ display: showListSetting ? 'none' : 'block' }}>
                <div className={cx('items-list-body')}>
                  <div className={cx('body-items')}>
                    <div className={cx('body-item')}>
                      <div className={cx('item-title')}>
                        <p>Hình nền</p>
                      </div>
                      <div className={cx('item-icon')} onClick={toggleBgSt}>
                        <FontAwesomeIcon
                          className={cx('st-icon')}
                          icon={faToggleOn}
                          style={{
                            display: toggleBackgroundSt ? 'block' : 'none',
                            color: toggleBackgroundSt ? 'rgb(140, 56, 214)' : 'transparent',
                          }}
                        />
                        <FontAwesomeIcon
                          className={cx('st-icon')}
                          icon={faToggleOff}
                          style={{ display: toggleBackgroundSt ? 'none' : 'block' }}
                        />
                      </div>
                    </div>
                    <div className={cx('body-item', 'music-ds')}>
                      <div className={cx('item-title')}>
                        <p>Chỉ phát nhạc nền</p>
                      </div>
                      <div className={cx('item-icon')}>
                        <FontAwesomeIcon className={cx('st-icon')} icon={faToggleOn} />
                        <FontAwesomeIcon className={cx('st-icon')} icon={faToggleOff} />
                      </div>
                    </div>
                    <div className={cx('body-item', 'music-si')}>
                      <div className={cx('item-title')}>
                        <p>Cỡ chữ lời nhạc</p>
                      </div>
                      <div className={cx('item-icon')}>
                        <FontAwesomeIcon className={cx('st-icon-size-s')} icon={faCircleH} />
                        <FontAwesomeIcon className={cx('st-icon-size-l')} icon={faCircleH} />
                        <FontAwesomeIcon className={cx('st-icon-size-xl')} icon={faCircleH} />
                      </div>
                    </div>
                    <div className={cx('body-item')} onClick={togglePMSt}>
                      <div className={cx('item-title')}>
                        <p>Luôn phát nhạc toàn màn hình</p>
                      </div>
                      <div className={cx('item-icon')}>
                        <FontAwesomeIcon
                          className={cx('st-icon')}
                          icon={faToggleOn}
                          style={{
                            display: togglePlayMusicSt ? 'block' : 'none',
                            color: togglePlayMusicSt ? 'rgb(140, 56, 214)' : 'transparent',
                          }}
                        />
                        <FontAwesomeIcon
                          className={cx('st-icon')}
                          icon={faToggleOff}
                          style={{ display: togglePlayMusicSt ? 'none' : 'block' }}
                        />
                      </div>
                    </div>
                  </div>
        ...
        <div className={cx('board-body')}>
          ...
          >
            ...
            <div className={cx('body-playlist-items')}>
              <div className={cx('playlist-item', 'first')}>
              ...
              <div className={cx('playlist-item')}>
                <div className={cx('pl-item-img')}>
                  <img src="/imgzingchart/3.jpg" alt="Chúng Ta Không Thuộc Về Nhau" />
                </div>
                <div className={cx('pl-item-icon')}>
                  <span className={cx('pl-icon-heart')}>
                    <p>
              ...
              <div className={cx('playlist-item')}>
                <div className={cx('pl-item-img')}>
                  <img src="/imgzingchart/6.jpg" alt="Chúng Ta Không Thuộc Về Nhau" />
                </div>
                <div className={cx('pl-item-icon')}>
                  <span className={cx('pl-icon-heart')}>
                    <p>
              ...
              <div className={cx('playlist-item')}>
                <div className={cx('pl-item-img')}>
                  <img src="/imgzingchart/7.jpg" alt="Chúng Ta Không Thuộc Về Nhau" />
                </div>
                <div className={cx('pl-item-icon')}>
                  <span className={cx('pl-icon-heart')}>
                    <p>
              ...
              <div className={cx('playlist-item')}>
                <div className={cx('pl-item-img')}>
                  <img src="/imgzingchart/2.jpg" alt="Chúng Ta Không Thuộc Về Nhau" />
                </div>
                <div className={cx('pl-item-icon')}>
                  <span className={cx('pl-icon-heart')}>
                    <p>
          ...
          >
            ...
            <div className={cx('lyrics-songs')}>
              <span>
                <p> Niềm tin đã mất, giọt nước mắt cuốn kí ức anh chìm sâu</p>
