        ...
        <div className={cx('board-body')}>
          ...
          <div className={cx('board-body-lyrics')}>
            ...
            <div className={cx('lyrics-songs')}>
              <span>
                Niềm tin đã mất, giọt nước mắt cuốn kí ức anh chìm sâu Tình về nơi đâu, cô đơn đôi chân lạc trôi giữa
                bầu trời Màn đêm che giấu, từng góc tối khuất lấp phía sau bờ môi! Tại vì anh thôi, yêu say mê nên đôi
                khi quá dại khờ! Nhắm mắt ơ thờ anh không muốn lạc vào trong nỗi đau này Phía trước bây giờ ai đang nắm
                chặt bàn tay của em vậy ... Ai vậy ??? Mông lung như một trò đùa Anh xin giơ tay rút lui thôi Do ai ???
                Trách ai bây giờ đây ???? Uhhhhhh .... Chúng ta không thuộc về nhau Chúng ta không thuộc về nhau Chúng
                ta không thuộc về nhau Em hãy cứ đi bên người mà em cần Trái tim không thuộc về nhau Giấc mơ không là
                của nhau Xoá câu ca buồn chiều mưa Anh lỡ xoá luôn yêu thương ngày xưa rồi Chúng ta không thuộc về nhau
                Hey... Từng đêm qua ... Cơn mưa bao vây chia rời đôi ta Em ... Ngày hôm qua ... Cuốn gió theo mây đi về
                nơi xa Trời xanh rộng bao la Anh lê đôi chân mình, Bơ vơ lang thang có lẽ Em đang yên vui bên nhân tình
                Quên đi để anh nhớ Hơi men để anh mơ Nơi đâu để anh giấu Một nỗi buồn vào trong thơ Nhắm mắt ơ thờ anh
                không muốn lạc vào trong nỗi đau này Phía trước bây giờ ai đang nắm chặt bàn tay của em vậy Mông lung
                như một trò đùa Anh xin giơ tay rút lui thôi Do ai ??? Trách ai bây giờ đây ???? Uhhhhhh .... Chúng ta
                không thuộc về nhau Chúng ta không thuộc về nhau Chúng ta không thuộc về nhau Em hãy cứ đi bên người mà
                em cần Trái tim không thuộc về nhau Giấc mơ không là của nhau Xoá câu ca buồn chiều mưa Anh lỡ xoá luôn
                yêu thương ngày xưa rồi Chúng ta không thuộc về nhau Chúng ta không thuộc về nhau Không thuộc về nhau
                ... Không thuộc về nhau ... Chúng ta không thuộc về nhau Không thuộc về nhau ... Không thuộc về nhau ...
                Chúng ta không thuộc về nhau Chúng ta không thuộc về nhau Chúng ta không thuộc về nhau Em hãy cứ đi bên
                người mà em cần Trái tim không thuộc về nhau Giấc mơ không là của nhau Xoá câu ca buồn chiều mưa Anh lỡ
                xoá luôn yêu thương ngày xưa rồi Chúng ta không thuộc về nhau !!!
              </span>
            </div>
          </div>
        </div>
