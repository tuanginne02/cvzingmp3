...
function LoadMusic() {
  ...
  const [togglePlayMusicSt, setTogglePlayMusicSt] = useState(true);
                  ...
                  <div className={cx('body-items')}>
                    ...
                    <div className={cx('body-item', 'music-ds')} >
                      ...
                      <div className={cx('item-icon')}>
                        ...
                        />
                        <FontAwesomeIcon className={cx('st-icon')} icon={faToggleOff}   style={{ display: togglePlayMusicSt ? 'none' : 'block' }}/>
                      </div>
                    </div>
                    ...
                    <div className={cx('body-item')} onClick={toggleBgSt}>
                      <div className={cx('item-title')}>
                        <p>Luôn phát nhạc toàn màn hình</p>
                      </div>
                      <div className={cx('item-icon')}>
                        <FontAwesomeIcon className={cx('st-icon')} icon={faToggleOn}  style={{
