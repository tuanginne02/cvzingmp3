                  ...
                  <div className={cx('body-items')}>
                    <div className={cx('body-item')}>
                      ...
                      <div className={cx('item-icon')}>
                        <FontAwesomeIcon className={cx('st-icon')} icon={faToggleOn}  style ={{ display : toggleBackgroundSt ? 'block' : ''}}/>
                        <FontAwesomeIcon className={cx('st-icon')} icon={faToggleOff}  style ={{ display : toggleBackgroundSt ? 'block' : ''}}/>
                      </div>
                    </div>
