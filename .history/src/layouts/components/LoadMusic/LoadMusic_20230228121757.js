                  ...
                  <div className={cx('body-items')}>
                    <div className={cx('body-item')}>
                      ...
                      <div className={cx('item-icon')}>
                        <FontAwesomeIcon className={cx('st-icon')} icon={faToggleOn}  style ={{ display : toggleBackgroundSt }}/>
                        <FontAwesomeIcon className={cx('st-icon')} icon={faToggleOff}  style ={{ display : toggleBackgroundSt }}/>
                      </div>
                    </div>
