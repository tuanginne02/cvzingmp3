    ...
    <div className={cx('loadMusic')}>
      ...
      >
        ...
        <div className={cx('board-body')}>
          <div className={cx('board-body-playlist')}>
            <div className={cx('body-playlist-items')}>
              <div className={cx('playlist-item')}>
               ...
               <span className={cx('pl-icon')}>   <FontAwesomeIcon icon={faHeart} /></span>
               <span className={cx('pl-icon')}>   <FontAwesomeIcon icon={faCirclePlay} /></span >
                </div>
              </div>
            </div>
          </div>
