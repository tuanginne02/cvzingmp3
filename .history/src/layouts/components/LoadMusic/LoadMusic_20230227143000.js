      ...
      >
        <div className={cx('board-header')}>
          ...
          <div className={cx('board-header-center')}>
            <div className={cx('header-center-items')} style={{ backgroundColor: showPlayListBoard ? 'red' : 'transparent',
            color: showPlayListBoard ? 'red' : '#fff'
          }}>
              <span>Danh sách phát</span>
            </div>
            <div className={cx('header-center-items')} style={{ backgroundColor: showPlayListBoard ? 'red' : 'transparent',
            color: showKaraokeBoard ? 'red' : '#fff'
          }}>
              <span>Karaoke</span>
            </div>
            <div className={cx('header-center-items')} style={{ backgroundColor: showPlayListBoard ? 'transparent' : 'rgba(89, 84, 96, 0.8)',
            color: showLyricsBoard ? '#fff' : '#fff'
          }}>
