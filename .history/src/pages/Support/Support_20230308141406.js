        ...
        <div className={cx('support-footer')}>
            <div className={cx('footer-container')}>
                ...
                <div className={cx('footer-connect')}>
                    <div className={cx('connect-mail')}>
                        <p>Chăm sóc khách hàng hàng</p>
                        <div className={cx('mail-name')}>
                            <FontAwesomeIcon icon={faEnvelope} />
                            <p>tuquoctuan071102@gmail.com </p>
                        </div>
                    </div>
                    <div className={cx('connect-phone')}>
                    <FontAwesomeIcon icon={faPhone} />
                    <p>(+84) 1234567890 1234567890(1234567890Ext: 0711)</p>
