        ...
        <div className={cx('update-vip-content')}>
          ...
          <div className={cx('content-quesition')}>
            ...
            <div className={cx('heading-answer')}>
                <p>Zing MP3 là dịch vụ nghe nhạc Online Online chất lượng cao, kết hợp cùng các tiện ích dành riêng cho thành viên VIP</p>
            </div>
          </div>
            <div className={cx('content-utilities')}>
                <div className={cx('utilities-items')}>
                <div className={cx('utilities-items')}></div>
