            ...
            <div className={cx('content-body-offer')}>
                ...
                <div className={cx('offer-package-item')}>
                    ...
                    <div className={cx('offer-package-dowload')}>
                        <div className={cx('dowload-title')}>
                            <p>Tải app</p>
                            <span>Zing MP3</span>
                            <p>để đăng ký ngay</p>
                        </div>
                        <div className={cx('dowload-app')}>
                            <div className={cx('app-gg')}>
                                <img src='/public/imgUpDateVIP/badge-google-play-vn.svg'
                            </div>
                            <div className={cx('app-ap')}>
                                <img src='/public/imgUpDateVIP/badge-app-store-vn.svg'
                            </div>
