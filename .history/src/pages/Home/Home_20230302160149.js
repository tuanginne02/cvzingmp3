        ...
        <div className={cx('header-slider')}>
          ...
          <div className={cx('img-slider-items')}>
            <div
              ...
              style={{
                left: changeSlider1 ? 'translateX(500%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                left: changeSlider2 ? 'translateX(300%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                left: changeSlider3 ? 'translateX(105%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                left: changeSlider4 ? 'translateX(-105%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                left: changeSlider5 ? 'translateX(-310%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                left: changeSlider6 ? 'translateX(-515%)' : 'translateX(0%)',
              }}
            >
