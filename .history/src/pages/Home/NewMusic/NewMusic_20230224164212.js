      ...
      <div className={cx('list-top')}>
        ...
        <div className={cx('list-items')}>
          ...
          <div className={cx('list-item')}>
            <div className={cx('item-img')}>
              <div className={cx('img-topweek')}>
                <img className={cx('img-1')} src="/imgnewmusic/2.jpg" alt="newmusic" />
              </div>
              <div className={cx('item-icon')}>
                <FontAwesomeIcon className={cx('icon-left')} icon={faHeart} />
                <FontAwesomeIcon className={cx('icon-center')} icon={faCirclePlay} />
          ...
          <div className={cx('list-item')}>
            <div className={cx('item-img')}>
              <div className={cx('img-topweek')}>
                <img className={cx('img-1')} src="/imgnewmusic/3.jpg" alt="newmusic" />
              </div>
              <div className={cx('item-icon')}>
                <FontAwesomeIcon className={cx('icon-left')} icon={faHeart} />
                <FontAwesomeIcon className={cx('icon-center')} icon={faCirclePlay} />
          ...
          <div className={cx('list-item')}>
            <div className={cx('item-img')}>
              <div className={cx('img-topweek')}>
                <img className={cx('img-1')} src="/imgnewmusic/4.jpg" alt="newmusic" />
              </div>
              <div className={cx('item-icon')}>
                <FontAwesomeIcon className={cx('icon-left')} icon={faHeart} />
                <FontAwesomeIcon className={cx('icon-center')} icon={faCirclePlay} />
          ...
          <div className={cx('list-item')}>
            <div className={cx('item-img')}>
              <div className={cx('img-topweek')}>
                <img className={cx('img-1')} src="/imgnewmusic/5.jpg" alt="newmusic" />
              </div>
              <div className={cx('item-icon')}>
                <FontAwesomeIcon className={cx('icon-left')} icon={faHeart} />
                <FontAwesomeIcon className={cx('icon-center')} icon={faCirclePlay} />
