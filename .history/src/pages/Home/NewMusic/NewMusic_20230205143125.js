      ...
      <div className={cx('list-top')}>
        ...
        <div className={cx('list-items')}>
          ...
          <div className={cx('list-item')}>
            ...
            <div className={cx('item-title')}>
              <span className={cx('name-title')}>US-UK Tháng 2</span>
              <span className={cx('information-title')}>
                <p>Miley Cyrus, </p>
                <p>Sam SmitSmith</p>
              </span>
          ...
          <div className={cx('list-item')}>
            ...
            <div className={cx('item-title')}>
              <span className={cx('name-title')}>K-Pop Tháng 2</span>
              <span className={cx('information-title')}>
                <p>NCT 127, </p>
                <p>TAEYANG</p>
              </span>
          ...
          <div className={cx('list-item')}>
            ...
            <div className={cx('item-title')}>
              <span className={cx('name-title')}>C-Pop Tháng 2</span>
              <span className={cx('information-title')}> <p>Hoàng Thùy Linh, </p>
                <p>Vũ Cát Tường</p></span>
            </div>
          </div>{' '}
          <div className={cx('list-item')}>
            <div className={cx('item-img')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
