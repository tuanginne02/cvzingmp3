...
function Radio() {
  const [changeClickColorPre, setChangeClickColorPrev] = useState(false);
  const [changeClickColorNext, setChangeClickColorNext] = useState(false);
      ...
      <div className={cx('radio-container')}>
        ...
        <div className={cx('prev-next')}>
          <span
            className={cx('prev')}
            style={{
              backgroundColor: changeClickColorPre ? 'rgba(89, 84, 96, 0.1)' : '',
            }}
          >
          ...
          <span
            className={cx('next')}
            style={{
              backgroundColor: changeClickColor ? 'rgba(89, 84, 96, 0.1)' : '',
            }}
          >
