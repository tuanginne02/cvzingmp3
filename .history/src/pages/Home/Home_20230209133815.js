          ...
          <div className={cx('header-filler')} l>
            <div className={cx('header-filler-left')}>
              <button
                ...
                style={{
                  backgrounColor: changeColorAll ? 'rgb(155, 77, 224)' : 'transparent',
                }}
              >
                TẤT CẢ
              </button>
              <button
                className={cx('btn-filler')}
                style={{
                  backgrounColor: changeColorVN ? 'transparent' : 'rgb(155, 77, 224)',
                }}
              >
                VIỆT NAM
              </button>
              <button
                className={cx('btn-filler')}
                style={{
                  backgrounColor: changeColorAll ? 'transparent' : 'rgb(155, 77, 224)',
                }}
              >
                QUỐC TẾ
              </button>
