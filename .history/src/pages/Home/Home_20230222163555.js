        ...
        <div className={cx('header-slider')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
          ...
          <div className={cx('img-slider-items')}>
            <div
              ...
              style={{
                transform: changeSlider1 ? 'translateX(500%)' : 'translateX(300%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider2 ? 'translateX(300%)' : 'translateX(100%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider3 ? 'translateX(100%)' : 'translateX(-100%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider4 ? 'translateX(-100%)' : 'translateX(-300%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider5? 'translateX(-300%)' : 'translateX(-500%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider6 ? 'translateX(-500%)' : 'translateX(-600%)',
              }}
            >
