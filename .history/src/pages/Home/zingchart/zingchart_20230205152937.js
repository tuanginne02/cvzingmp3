          ...
          <div className={cx('zingchart-items')}>
            <div className={cx('zingchart-item')}>
              <div className={cx('list-zingchart-img')}>
                <img src="/public/imgListMusic1.webp" alt="1" />
            ...
            <div className={cx('zingchart-item')}>
              <div className={cx('list-zingchart-img')}>
                <img src="/public/imgListMusic2.webp" alt="1" />
              </div>
              <div className={cx('list-zingchart-title')}>
            ...
            <div className={cx('zingchart-item')}>
              <div className={cx('list-zingchart-img')}>
                <img src="/public/imgListMusic3.webp" alt="1" />
              </div>
              <div className={cx('list-zingchart-title')}>
            ...
            <div className={cx('zingchart-item')}>
              <div className={cx('list-zingchart-img')}>
                <img src="/public/imgListMusic4.webp" alt="1" />
              </div>
              <div className={cx('list-zingchart-title')}>
