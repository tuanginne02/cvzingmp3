...
function grnerateItems () {
  ...
  for ( var i = active - 2; i < active + 3; i++) {
    ...
    level = active - i
    items.push(<Item key={index} id={items[index]} level)
  }
}
    ...
    <div className={cx('home')}>
      <div className={cx('header-home')}>
        <div className={cx('header-slider')}>
            ...
            <div className={cx('slide-prev')} onClick={()=> {
              handlClickPrev1();
              handlClickPrev2();
              handlClickPrev3();
              handlClickPrev4();
          ...
          <div className={cx('slide-next')} onClick={()=> {
              handlClickPrev1();
              handlClickPrev2();
              handlClickPrev3();
              handlClickPrev4();
