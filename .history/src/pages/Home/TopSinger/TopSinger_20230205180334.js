          ...
          <div className={cx('topsinger-items')}>
            <div className={cx('topsinger-item')}>
              <div className={cx('item-img')}>
                <img className={cx('img-radio')} src="/public/imgsinger//1.webp" alt="radio" />
              </div>
            </div>
            <div className={cx('topsinger-item')}>
              <div className={cx('item-img')}>
                <img className={cx('img-radio')} src="/public/imgsinger//2.webp" alt="radio" />
              </div>
            </div>
            <div className={cx('topsinger-item')}>
              <div className={cx('item-img')}>
                <img className={cx('img-radio')} src="/public/imgsinger//3.webp" alt="radio" />
              </div>
            </div>
            <div className={cx('topsinger-item')}>
              <div className={cx('item-img')}>
                <img className={cx('img-radio')} src="/public/imgsinger//4.webp" alt="radio" />
              </div>
            </div>
            <div className={cx('topsinger-item')}>
                <div className={cx('item-img')}>
                    <img className={cx('img-radio')} src="/public/imgsinger//5.webp" alt="radio" />                
                </div>   
            </div>
            <div className={cx('topsinger-item')}>
                <div className={cx('item-img')}>
                    <img className={cx('img-radio')} src="/public/imgsinger//6.webp" alt="radio" />               
                </div>  
            </div>
          </div>
        </div>
