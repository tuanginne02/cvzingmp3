        ...
        <div className={cx('topsinger-bottom')}>
          ...
          <div className={cx('singer-name')}>
            <div
              ...
              style={{
                transform: changeClickColorPrevPrev ? 'translateX(0px)' : 'translateX(-1145px)',
              }}
            >
            ...
            <div
              className={cx('topsinger-items')}
              style={{
                transform: changeClickColorNext ? 'translateX(0px)' : 'translateX(-1145px)',
              }}
            >
              <div className={cx('topsinger-item')}>
                <div className={cx('item-img')}>
              ...
              <div className={cx('topsinger-item')}>
                <div className={cx('item-img')}>
                  <img className={cx('img-radio')} src="/imgsinger/8.png" alt="radio" />
                </div>
              </div>
              <div className={cx('topsinger-item')}>
                <div className={cx('item-img')}>
                  <img className={cx('img-radio')} src="/imgsinger/9.png" alt="radio" />
                </div>
              </div>
              <div className={cx('topsinger-item')}>
                <div className={cx('item-img')}>
                  <img className={cx('img-radio')} src="/imgsinger/10.png" alt="radio" />
                </div>
              </div>
              <div className={cx('topsinger-item')}>
                <div className={cx('item-img')}>
