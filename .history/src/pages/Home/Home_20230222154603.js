...
function Home() {
  ...
  const [changeSlider2, setChangeSlider] = useState(false);
  const [changeSlider3, setChangeSlider] = useState(false);
  const [changeSlider4, setChangeSlider] = useState(false);
  const [changeSlider5, setChangeSlider] = useState(false);
  const [changeSlider6, setChangeSlider] = useState(false);
        ...
        <div className={cx('header-slider')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
          ...
          <div className={cx('img-slider-items')}>
            <div
              ...
              style={{
                transform: changeSlider ? 'translateX(200%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider ? 'translateX(150%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider ? 'translateX(100%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider ? 'translateX(-400px)' : 'translateX(0px)',
              }}
            >
