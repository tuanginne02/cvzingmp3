...
function Home() {
  ...
  const handlClickPrev = () => {
    setChangeSlider((current) => !current);
  };
        ...
        <div className={cx('header-slider')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
          ...
          <div className={cx('img-slider-items')}>
            <div
              ...
              style={{
                transition: changeSlider ? ' all 10s ease' : '',
              }}
            >
              <img
                className={cx('img-sl')}
                ...
                style={{
                  transform: changeSlider ? 'translateX(-375px)' : 'translateX(0px)',
                   animation: changeSlider ? 'translateX(-375px)' : 'translateX(0px)',
                }}
              />
            </div>
              ...
              <img
                ...
                style={{
                  transform: changeSlider ? 'translateX(-400px)' : 'translateX(0px)',
                   animation: changeSlider ? 'translateX(-400px)' : 'translateX(0px)',
                }}
              />
            </div>
            <div className={cx('slider__img')}>
              ...
              <img
                ...
                style={{
                  transform: changeSlider ? 'translateX(-285px)' : 'translateX(0px)',
                   animation: changeSlider ? 'translateX(-285px)' : 'translateX(0px)',
                }}
              />
            </div>
          </div>
