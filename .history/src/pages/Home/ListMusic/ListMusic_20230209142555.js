    ...
    <div className={cx('list-music')}>
      <div className={cx('list-music-content')}>
        <div className={cx('music-items')}>
          <div className={cx('music-item')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
            ...
            <div
              ...
              style={{
                display: changeHoverShow ? 'flex' : 'flex',
              }}
            >
          ...
          <div className={cx('music-item')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
            ...
            <div className={cx('list-music-title')}>
              <span className={cx('name-singer')}>Có Một Ngày Trời Không Nắng</span>
              <span className={cx('name-song')}>Thái Đinh</span>
              <span> 1 Tháng trước</span>
            </div>
            <div
              className={cx('icon-left-list')}
          ...
          <div className={cx('music-item')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
            ...
            <div className={cx('list-music-title')}>
              <span className={cx('name-singer')}>Kỉ Niệm Giam Cầm Chúng Ta</span>
          ...
          <div className={cx('music-item')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
            ...
            <div className={cx('list-music-title')}>
              <span className={cx('name-singer')}>Xin Lỗi Em Không Onnr </span>
              <span className={cx('name-song')}>Thái Đinh</span>
              <span> 1 Tháng trước</span>
            </div>
            <div
