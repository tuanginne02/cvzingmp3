...
function ListMusic() {
  ...
  return (
    <div className={cx('list-music')}>
      ...
      <div
        className={cx('list-music-content')}
        style={{
          display: changeColorAll ? 'block' : 'none',
        }}
      >
            ...
            <div className={cx('item-content')}>
              <div className={cx('content-body')}>
                ...
                <div className={cx('list-music-title')}>
                  <span className={cx('name-singer')}>Lặng Im AAll</span>
      ...
      <div
        className={cx('list-music-content')}
        style={{
          display: changeColorVN ? 'none' : 'block',
        }}
      >
        <div className={cx('music-items')}>
          <div className={cx('music-item')}>
            <div className={cx('item-content')}>
              <div className={cx('content-body')}>
                ...
                <div className={cx('list-music-title')}>
                  <span className={cx('name-singer')}>Lặng Im NNam</span>
                  <span className={cx('name-song')}>Hakoota Dũng Hà</span>
                  <span> 1 Tháng trước</span>
                </div>
              </div>
      ...
      <div
        className={cx('list-music-content')}
        style={{
          display: changeColorQT ? 'none' : 'block',
        }}
      >
        <div className={cx('music-items')}>
          <div className={cx('music-item')}>
            <div className={cx('item-content')}>
              <div className={cx('content-body')}>
                ...
                <div className={cx('list-music-title')}>
                  <span className={cx('name-singer')}>Lặng Im Tế</span>
                  <span className={cx('name-song')}>Hakoota Dũng Hà</span>
                  <span> 1 Tháng trước</span>
                </div>
              </div>
