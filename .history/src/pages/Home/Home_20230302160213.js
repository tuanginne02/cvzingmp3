        ...
        <div className={cx('header-slider')}>
          ...
          <div className={cx('img-slider-items')}>
            <div
              ...
              style={{
                left: changeSlider1 ? 'translateX(500%)' : '',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                left: changeSlider2 ? 'translateX(300%)' : '',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                left: changeSlider3 ? 'translateX(105%)' : '',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                left: changeSlider4 ? 'translateX(-105%)' : '',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                left: changeSlider5 ? 'translateX(-310%)' : '',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                left: changeSlider6 ? 'translateX(-515%)' : '',
              }}
            >
