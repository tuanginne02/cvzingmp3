...
function Home() {
  ...
  const handlClickPrev = () => {
    setChangeSlider1((current));
    setChangeSlider2((current));
    setChangeSlider3((current));
    setChangeSlider4((current));
    setChangeSlider5((current));
    setChangeSlider6((current));
        ...
        <div className={cx('header-slider')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
          ...
          <div className={cx('img-slider-items')}>
            <div
              ...
              style={{
                transform: changeSlider1 ? 'translateX(200%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider2 ? 'translateX(150%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider3 ? 'translateX(100%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider4 ? 'translateX(-100%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider5? 'translateX(-300%)' : 'translateX(0%)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider6 ? 'translateX(-500%)' : 'translateX(0%)',
              }}
            >
