...
function Home() {
  ...
  const handlClickPrev = () => {
    setChangeSlider1(true);
    setChangeSlider2(true);
    setChangeSlider23(true);
    setChangeSlider(4true);
    setChangeSlider(5true);
    setChangeSlider6(true);
        ...
        <div className={cx('header-slider')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
          ...
          <div className={cx('img-slider-items')}>
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider4 ? 'translateX(-400px)' : 'translateX(0px)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider5? 'translateX(-285px)' : 'translateX(0px)',
              }}
            >
            ...
            <div
              className={cx('slider__img')}
              style={{
                transform: changeSlider6 ? 'translateX(-285px)' : 'translateX(0px)',
              }}
            >
