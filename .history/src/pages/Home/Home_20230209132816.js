...
function Home() {
  ...
  const [changeColorFillter, setChangeColorFillter] = useState(true);
  function ch
  return (
        ...
        <div className={cx('zing-chart')}>
          ...
          <div className={cx('zingchar-playlist')} >
            <div className={cx('zing-chart-img')} >
              <img src="/img/homeZingchart.jpg" alt="zingchart" onMouseOver={handlOnMouse1} onMouseOut={handlOutMouse1} 
               style={{
