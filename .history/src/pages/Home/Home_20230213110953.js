        ...
        <div className={cx('header-slider')} onMouseOver={handlOnMouse} onMouseOut={handlOutMouse}>
          ...
          <div className={cx('img-slider-items')}>
            <div
              ...
              style={{
                transition: changeSlider ? ' all 10s easeease' : '',
              }}
            >
              <img
                className={cx('img-sl')}
                ...
                alt=""
                style={{
                  transform: changeSlider ? 'translateX(-375px) scale(0.5)' : 'translateX(0px) scale(1',
                }}
              />
            </div>
            <div className={cx('slider__img')}>
              <img
                ...
                alt=""
                style={{
                  transform: changeSlider ? 'translateX(-400px) scale(0.5)' : 'translateX(0px) scale(1',
                }}
              />
            </div>
            <div className={cx('slider__img')}>
