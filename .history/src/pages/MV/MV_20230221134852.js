      ...
      <div className={cx('mv-container')}>
        ...
        <div className={cx('mv-content')}>
          <div className={cx('content-coutry')}>
            <div className={cx('mvvn')} style={{display: changeshow }}>
              <VN />
            </div>
            <div className={cx('mvkp')} style={{display: changeshow }}>
              <KP />
            </div>
            <div className={cx('mvusk') style={{display: changeshow }}}>
              <USK />
            </div>
            <div className={cx('mvht')} style={{display: changeshow }}>
              <HT />
            </div>
          </div>
        </div>
