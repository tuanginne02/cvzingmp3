      ...
      <div className={cx('mv-container')}>
        <div className={cx('mv-header')}>
          ...
          <div className={cx('mv-country')}>
            ...
            >
              <span>Việt Nam</span>
              <div className={cx('ctr-vn')} style={{ display: showPageVn ? 'none' : 'block' }}></div>
            </div>
            <div
            ...
            >
              <span>US-UK</span>
              <div className={cx('ctr-usk')} style={{ display: showPageUsk ? 'none' : 'block' }}></div>
            </div>
            <div
            ...
            >
              <span>KPOP</span>
              <div className={cx('ctr-kp')} style={{ display: showPageKp ? 'none' : 'block' }}></div>
            </div>
            <div
            ...
            >
              <span>Hòa Tấu</span>
              <div className={cx( 'ctr-ht')} style={{ display: showPageHt ? 'none' : 'block' }}></div>
            </div>
          </div>
        </div>
