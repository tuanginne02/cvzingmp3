...
function MVVN() {
  ...
  const showMusicPlay = () => setShowPlay(true);
  const hiddenMusicPlay = () => setShowPlay(false);

  const [theOneListShow, setTheOneListShow] = useState(true);
  const oneTheListShow = () => setTheOneListShow(false);
      ...
      <div className={cx('mvvn-container')}>
          ...
          <div className={cx('header-filler')}>
            ...
            >
              ...
              <div
                ...
                style={{
                  display: fillterList ? 'none' : 'block',
                  opacity: oneTheListShow ? '1' : '',
                  visibility: oneTheListShow ? 'visible' : 'hidden',
                }}
              >
                <ListAll />
              </div>
            </div>
            <div className={cx('btn-listien')} onClick={listenList}     onClick={() => {
                allList();
                theOneListShow();
              }}>
              ...
              <div
                ...
                style={{
                  display: fillterListen ? 'none' : 'block',
                  opacity: oneTheListShow ? '' : '1',
                  visibility: oneTheListShow ? 'hidden' : 'visible',
                }}
              >
                <ListenMore />
              </div>
        ...
        <div className={cx('vn-content')}>
          <div className={cx('content-items')}>
            <div className={cx('content-item')}>
              <div className={cx('mv-img')}>
                <img
                  ...
                  src="/imgmv/1.webp"
                  alt=" "
                  onMouseOver={showMusicPlay}
                  onMouseOut={hiddenMusicPlay}
                />
            ...
            <div className={cx('content-item')}>
              <div className={cx('mv-img')} onMouseOver={showMusicPlay} onMouseOut={hiddenMusicPlay}>
