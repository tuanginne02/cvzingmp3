      ...
      <div className={cx('mv-container')}>
        ...
        <div className={cx('mv-content')}>
          <div className={cx('content-coutry')}>
            <div className={cx('mvvn')} style={{display: change}}>
              <VN />
            </div>
            <div className={cx('mvkp')} style={{display: change}}>
              <KP />
            </div>
            <div className={cx('mvusk') style={{display: change}}}>
              <USK />
            </div>
            <div className={cx('mvht')} style={{display: change}}>
              <HT />
            </div>
          </div>
        </div>
