      ...
      <div className={cx('mv-container')}>
        <div className={cx('mv-header')}>
          ...
          <div className={cx('mv-country')}>
            ...
            <div onClick={{handleClickShowPageUsk}} className={cx('name-ctr')} style={{ color: showPageUsk ? '#fff' : '#ffffff8a' }}>
              <span>US-UK</span>
            </div>
            <div onClick={{handleClickShowPageKp}} className={cx('name-ctr')} style={{ color: showPageKp ? '#fff' : '#ffffff8a' }}>
              <span>KPOP</span>
            </div>
            <div onClick={{}} className={cx('name-ctr')} style={{ color: showPageHt ? '#fff' : '#ffffff8a' }}>
              <span>Hòa Tấu</span>
            </div>
          </div>
        </div>
