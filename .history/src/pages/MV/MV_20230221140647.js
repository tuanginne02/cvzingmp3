      ...
      <div className={cx('mv-container')}>
        <div className={cx('mv-header')}>
          ...
          <div className={cx('mv-country')}>
            <div className={cx('name-ctr')} style={{ color: showPageVn ? '#ffffff8a' : '#fff' }}>
              <span>Việt Nam</span>
            </div>
            <div className={cx('name-ctr')} style={{ color: showPageUsk ? '#fff' : '#ffffff8a' }}>
              <span>US-UK</span>
            </div>
            <div className={cx('name-ctr')} style={{ color: showPageKp ? '#fff' : '#ffffff8a' }}>
              <span>KPOP</span>
            </div>
            <div className={cx('name-ctr')} style={{ color: showPageHt ? '#fff' : '#ffffff8a' }}>
              <span>Hòa Tấu</span>
            </div>
          </div>
        </div>
