      ...
      <div className={cx('mv-container')}>
        ...
        <div className={cx('mv-content')}>
          <div className={cx('content-coutry')}>
            ...
            <div className={cx('mvkp')} style={{ display: showPageVn ? 'none' : 'block' }}>
              <KP />
            </div>
            <div className={cx('mvusk')} sstyle={{ display: showPageVn ? 'none' : 'block' }}>
              <USK />
            </div>
            <div className={cx('mvht')} style={{ display: showPageVn ? 'none' : 'block' }}>
              <HT />
            </div>
          </div>
        </div>
