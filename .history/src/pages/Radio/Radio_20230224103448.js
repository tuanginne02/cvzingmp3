...
function Radio() {
  ...
  const [changeClickCchannleNext, setChangeClickChannleNext] = useState(true);
  const handlOnClickChannleNext = () => {
    setChangeClickChannleNext((current) => !current);
  };
    ...
    <div className={cx('radio')}>
      <div className={cx('radio-container')} >
        ...
        <div className={cx('radio-items')}>
          <div className={cx('radio-item')}>
            ...
            <span>  <FontAwesomeIcon className={cx('play-radio-icon')} icon={faCirclePlay} /></span>
      ...
      <div className={cx('radio-channel')}>
        <div className={cx('channel-container')}>
          <div className={cx('prev-next')} onClick={handlOnClickChannleNext}>
            <span
              className={cx('prev')}
              style={{
                color: changeClickCchannleNext ? '#fff' : 'rgba(89, 84, 96, 0.1)',
              }}
            >
              <FontAwesomeIcon icon={faChevronCircleLeft} />
            </span>
            <span className={cx('next')}>
              <FontAwesomeIcon
                icon={faChevronCircleRight}
                style={{
                  color: changeClickCchannleNext ? 'rgba(89, 84, 96, 0)' : '#fff',
                }}
              />
            </span>
          </div>
