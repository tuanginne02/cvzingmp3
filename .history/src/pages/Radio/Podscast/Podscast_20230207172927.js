            ...
            <div className={cx('show-items')}>
              <div className={cx('show-item')}>
                ...
                <div className={cx('show-item-right')}>
                  <p>Tun Cảm Ơn</p>
                  <span>Đắp Chăn Nằm Nghe Tun Kể</span>
                  <p className={cx('active-show-Cas')}>Là series đầu tiên của Tun, nơi Tun và các bạn có thể trải lòng với nhau về những mệt mõi trong cuộc sống, cùng cho nhau nhũng lời khuyên hay ho, cùng chữa lành nững tổn thương, đổ vỡ để trái ti</p>
                </div>
              </div>
            </div>
            <div className={cx('show-items')}>
