            ...
            <div className={cx('show-items')}>
              <div className={cx('show-item')}>
                ...
                <div className={cx('show-item-right')}>
                  ...
                  <span>Đắp Chăn Nằm Nghe Tun Kể</span>
                  <p>
                    Là series đầu tiên của Tun, nơi Tun và các bạn có thể trải lòng với nhau về những mệt mõi trong cuộc
                    sống, cùng cho nhau nhũng lời khuyên hay ho, cùng chữa lành nững tổn thương, đổ vỡ để trái tim tụi
                    mình một lần nữa được ngận tràn yêu thương.
                  </p>
                </div>
              </div>
            </div>
            <div className={cx('show-items')}>
              <div className={cx('show-item')}>
                ...
                <div className={cx('show-item-right')}>
                  ...
                  <span>XONE With Starts</span>
                  <p>
                    Talkshow 1 tiếng với các ca sĩ, nhạc sĩ, rapper, music producer,...Hẹn hì cùng ccs nghệ sĩ trong
                    nước: Tóc Tiên, Đức ĐứcPhucs.. hay cuộc gặp gỡ độc quyền với các nghệ sĩ Quốc Tế: Alan Walker, Rita
                    Ora.. cùng XONE Radio
                  </p>
                  {/* <p>08/01/2023 . 10 phút</p> */}
                </div>
