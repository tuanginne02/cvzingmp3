            ...
            <div className={cx('show-items')}>
              <div className={cx('show-item')}>
                ...
                <div className={cx('show-item-right')}>
                  <p>XONE Radio</p>
                  <span>XONE With Starts</span>
                  <p className={cx('active-show-Cas')}>Talkshow 1 tiếng với các ca sĩ, nhạc sĩ, rapper, music producer,...Hẹn hì cùng ccs nghệ sĩ trong nước: Tóc Tiên, Đức ĐứcPhucs.. hay cuộc gặp gỡ độc quyền với các nghệ sĩ Quốc Tế: Alan Walker, Rita </p>
                  {/* <p>08/01/2023 . 10 phút</p> */}
                </div>
              </div>
            </div>
