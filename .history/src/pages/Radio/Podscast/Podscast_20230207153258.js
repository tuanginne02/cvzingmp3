      ...
      <div className={cx('podccast-container')}>
        ...
        <div className={cx('podcast-rank')}>
          ...
          <div className={cx('podcast-rank-items')}>
            <div className={cx('podcast-rank-item')}>
              <div className={cx('rank-item-left')}>
                <div className={cx('nub-rank')}>
                  <p>1</p>
                </div>
                <div className={cx('img-rank')}>
                  <img className={cx('img-rankTop')} src="/imgradio/podcast/1.jpg" alt="ỉmg-Rank" />
                </div>
              </div>
              <div className={cx('rank-item-right')}>
                <span>#34 Tình bạn là một sự đầu tư khôn ngoan | Đắp Chăn Namef Nghe Tun Kể</span>
                <p>Dắp Chăn Nằm Nghe Tun Kể</p></p>
              </div>
            </div>
          </div>
        </div>
