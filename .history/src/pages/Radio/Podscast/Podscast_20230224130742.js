...
import { faChevronRight, faPlay, faBookmark, faEllipsis } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className={cx('podcast')}>
      <div className={cx('podccast-container')}>
          ...
          <div className={cx('podcast-rank-items')}>
            <div className={cx('rank-items')}>
              <div className={cx('rank-item')}>
                ...
                <div className={cx('rank-item-bottom')}>
        ...
        <div className={cx('podcast-liveshow')}>
          <div className={cx('cont-title')}>
          ...
          <div className={cx('podcast-show-items')}>
            <div className={cx('show-items')}>
              <div className={cx('show-item')}>
                <div
                  className={cx('backg-blur')}
                  style={{
                    backgroundImage: 'url(/imgradio/podcast/1.jpg)',
                    width: '100%',
                    height: '100%',
                      filter: 'blur(35px)',
                      borderRadius: '20px',
                ...
                ></div>
                <div className={cx('show-item-left')}>
                  <div className={cx('img-show')}>
                    <img className={cx('img-show-Top')} src="/imgradio/podcast/1.jpg" alt="img-show" />
                    {/* <div className={cx('icon-show')}>
                      <FontAwesomeIcon className={cx('play-show')} icon={faPlay} />
                    </div> */}
                  </div>
                </div>
                <div className={cx('show-item-right')}>
                  <p>Tun Cảm Ơn</p>
                  <span>Đắp Chăn Nằm Nghe Tun Kể</span>
                  <p>Là series đầu tiên của Tun, nơi Tun và các bạn có thể trải lòng với nhau về những mệt mõi trong cuộc sống, cùng cho nhau nhũng lời khuyên hay ho, cùng chữa lành nững tổn thương, đổ vỡ để trái tim tụi mình một lần nữa được ngận tràn yêu thương.</p>
                </div>
              </div>
            </div>
            <div className={cx('show-items')}>
              <div className={cx('show-item')}>
                <div
                  className={cx('backg-blur')}
                  style={{
                    backgroundImage: 'url(/imgradio/podcast/3.png)',
                    width: '100%',
                    height: '100%',
                      filter: 'blur(35px)',
                      borderRadius: '20px',
                ...
                <div className={cx('show-item-left')}>
                  <div className={cx('img-show')}>
                    <img className={cx('img-show-Top')} src="/imgradio/podcast/3.png" alt="img-show" />
                    {/* <div className={cx('icon-show')}>
                      <FontAwesomeIcon className={cx('play-show')} icon={faPlay} />
                    </div> */}
                  </div>
                ...
                <div className={cx('show-item-right')}>
                  <p>XONE Radio</p>
                  <span>XONE With Starts</span>
                  <p>Talkshow 1 tiếng với các ca sĩ, nhạc sĩ, rapper, music producer,...Hẹn hì cùng ccs nghệ sĩ trong nước: Tóc Tiên, Đức ĐứcPhucs.. hay cuộc gặp gỡ độc quyền với các nghệ sĩ Quốc Tế: Alan Walker, Rita Ora.. cùng XONE Radio</p>
                  {/* <p>08/01/2023 . 10 phút</p> */}
                </div>
              </div>
            </div>
