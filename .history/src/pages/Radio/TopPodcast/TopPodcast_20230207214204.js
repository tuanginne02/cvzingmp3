      ...
      <div className={cx('topPod-container')}>
        <div className={cx('topPod-zingnews')}>
          <div className={cx('zingnews-header')}>
            ...
            <div className={cx('zingnew-title')}>
              <span>PODCAST</span>
              <h2 className={cx('active-nam')}>Zing News</h2>
            </div>
          </div>
        ...
        <div className={cx('topPod-zingnews')}>
          <div className={cx('zingnews-header')}>
            ...
            <div className={cx('zingnew-title')}>
              <span>PODCAST</span>
              <h2 className={cx('active-nam')}>Vietcetera</h2>
            </div>
          </div>
          <div className={cx('zingnew-content')}>
            <div className={cx('zn-cont-items')}>
        ...
        <div className={cx('topPod-zingnews')}>
          <div className={cx('zingnews-header')}>
            ...
            <div className={cx('zingnew-title')}>
              <span>PODCAST</span>
              <h2 className={cx('active-nam')}>Pladio</h2>
            </div>
          </div>
          <div className={cx('zingnew-content')}>
            <div className={cx('zn-cont-items')}>
        ...
        <div className={cx('topPod-zingnews')}>
          <div className={cx('zingnews-header')}>
            ...
            <div className={cx('zingnew-title')}>
              <span>Nghe Lại</span>
              <h2 className={cx('active-nam')}>On Air</h2>
            </div>
          </div>
          <div className={cx('zingnew-content')}>
            <div className={cx('zn-cont-items')}>
