...
function Radio() {
  ...
  const [changeClickChanel, setChangeClickChanel] = useState(true);
  const handlOnClickChannlePrev = () => {
    setChangeClickChanel(true);
  };
  const handlOnClickChannleNext = () => {
    setChangeClickChanel(false);
  };
    ...
    <div className={cx('radio')}>
      <div className={cx('radio-container')}>
        <div
          className={cx('prev')}
          style={{
            color: changeClickColorRadioTV ? '#fff' : 'rgba(89, 84, 96, 0.1)',
          }}
      ...
      <div className={cx('radio-channel')}>
        <div className={cx('channel-container')}>
          <div className={cx('prev-channel')}>
            <FontAwesomeIcon
              icon={faChevronCircleLeft}
              style={{
                color: changeClickChanel ? '#fff' : 'rgba(89, 84, 96, 0.1)',
              }}
              onClick={handlOnClickChannlePrev}
            />
          </div>
          ...
          <div className={cx('channel-left')}>
            ...
            <div className={cx('channel-left-content')}>
              <div className={cx('left-content-img')} id="1">
                <img className={cx('img-channel')} src="/imgradio/Chn1.jpg" alt="" />
                <FontAwesomeIcon className={cx('play-channel-icon')} icon={faCirclePlay} style={{}} />
              </div>
              <div className={cx('left-content-img')}>
                <img className={cx('img-channel')} src="/imgradio/Chn2.jpg" alt="" />
                <FontAwesomeIcon className={cx('play-channel-icon')} icon={faCirclePlay} style={{}} />
              </div>
            </div>
          </div>
          ...
          <div className={cx('next-channel')}>
            <FontAwesomeIcon
              icon={faChevronCircleRight}
              style={{
                color: changeClickChanel ? 'rgba(89, 84, 96, 0.1)' : '#fff',
              }}
              onClick={handlOnClickChannleNext}
            />
          </div>
        </div>
      </div>
