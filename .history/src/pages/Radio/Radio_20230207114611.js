...
function Radio() {
  ...
  const [changeOnMouseChannel, setChangeOnMouseChannle] = useState(false);
        ...
        <div className={cx('channel-container')}>
          <div className={cx('channel-left')}>
            ...
            <div className={cx('channel-left-content')}>
              <div className={cx('left-content-img')}  onMouseOver={handleOnMouseChannle} onMouseOut={handleOutMouseChannle}>
                <img className={cx('img-channel')} src="/imgradio/Chn1.jpg" alt="" />
                <FontAwesomeIcon className={cx('play-channel-icon')} icon={faCirclePlay} 
                 style={{
                display: changeOnMouseChannel ? 'flex' : 'none',
              }}
                />
              </div>
