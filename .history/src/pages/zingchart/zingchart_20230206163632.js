    ...
    <div className={cx('zingchart')}>
      <div className={cx('zingchart-conatiner')}>
        ...
        <div className={cx('zingchart-ranks')}>
          <div className={cx('rank-items')}  onMouseOver={handleOnMouse} onMouseOut={handleOutMouse}
 onMouseOver={handleOnMouse} onMouseOut={handleOutMouse}
 onMouseOver={handleOnMouse} onMouseOut={handleOutMouse}
 onMouseOver={handleOnMouse} onMouseOut={handleOutMouse}
 onMouseOver={handleOnMouse} onMouseOut={handleOutMouse}
 onMouseOver={handleOnMouse} onMouseOut={handleOutMouse}
              ...
              <div className={cx('rank-item-left')}>
                ...
                <div className={cx('left-item-left')}>
                  ...
                  <div className={cx('list-zingchart-title')}>
                   ...
                   <div className={cx('name-songs')}> <span className={cx('name-song-z')}>Phá Huy T4</span></div>
                  </div>
                </div>
              </div>
            ...
            <div className={cx('rank-item')}>
              <div className={cx('rank-item-left')}>
                ...
                <div className={cx('left-item-left')}>
                 ...
                 <div className={cx('name-songs')}>   <span className={cx('name-song-z')}>Dunghoangpham</span></div>
                  </div>
                </div>
              </div>
              <div className={cx('rank-item-center')}>
            ...
            <div className={cx('rank-item')}>
              <div className={cx('rank-item-left')}>
                ...
                <div className={cx('left-item-left')}>
                 ...
                 <div className={cx('name-songs')}>   <span className={cx('name-song-z')}>Jack - J97</span></div>
                  </div>
                </div>
              </div>
              <div className={cx('rank-item-center')}>
              ...
              <div className={cx('rank-item-left')}>
                ...
                <div className={cx('left-item-left')}>
                  ...
                  <div className={cx('list-zingchart-title')}>
                   ...
                   <div className={cx('name-songs')}> <span className={cx('name-song-z')}>H-Kray</span></div>
                  </div>
                </div>
              </div>
              <div className={cx('rank-item-center')}>
              ...
              <div className={cx('rank-item-left')}>
                ...
                <div className={cx('left-item-left')}>
                  ...
                  <div className={cx('list-zingchart-title')}>
                   ...
                   <div className={cx('name-songs')}> <span className={cx('name-song-z')}>Thiên Tú</span></div>
                  </div>
                </div>
              </div>
              <div className={cx('rank-item-center')}>
              ...
              <div className={cx('rank-item-left')}>
                ...
                <div className={cx('left-item-left')}>
                  ...
                  <div className={cx('list-zingchart-title')}>
                   ...
                   <div className={cx('name-songs')}> <span className={cx('name-song-z')}>O.lew</span></div>
                  </div>
                </div>
              </div>
              <div className={cx('rank-item-center')}>
              ...
              <div className={cx('rank-item-left')}>
                ...
                <div className={cx('left-item-left')}>
                  ...
                  <div className={cx('list-zingchart-title')}>
                   ...
                   <div className={cx('name-songs')}> <span className={cx('name-song-z')}>Thành Đạt</span></div>
                  </div>
                </div>
              </div>
              <div className={cx('rank-item-center')}>
