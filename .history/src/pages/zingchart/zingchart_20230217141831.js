...
// import { faHeart  style={{ color: changeColorHeart}}} from '@fortawesome/free-regular-svg-icons';
            ...
            <div className={cx('rank-item')} onMouseOver={handleOnMouse} onMouseOut={handleOutMouse}>
              ...
              <div className={cx('rank-item-right')}>
                ...
                >
                  ...
                  <p className={cx('p-icon')}>
                    <FontAwesomeIcon className={cx('right-icon')} icon={faHeart} style={{ color: changeColorHeart}} />
                  </p>
                  <p className={cx('p-icon')}>
