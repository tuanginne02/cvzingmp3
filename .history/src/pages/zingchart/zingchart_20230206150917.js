            ...
            <div className={cx('rank-item')}>
              ...
              <div className={cx('rank-item-right')}>
                ...
                <div className={cx('item-right-icon')}>
                  <FontAwesomeIcon className={Cx('right-iconicon')} icon={faMicrophone} />
                  <FontAwesomeIcon className={Cx('right-iconicon')} icon={faHeart} />
                  <FontAwesomeIcon className={Cx('right-iconicon')} icon={faEllipsis} />
                </div>
              </div>
            </div>
          </div>
