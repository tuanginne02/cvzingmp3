...
import { faEllipsis, faPlay, faMi,'heart'crophone,faHeart  } from '@fortawesome/free-solid-svg-icons';
// ,'heart'import { faHeart } from '@fortawesome/free-regular-svg-icons';
            ...
            <div className={cx('rank-item')} onMouseOver={handleOnMouse} onMouseOut={handleOutMouse}>
              ...
              <div className={cx('rank-item-right')}>
                ...
                >
                  ...
                  <p className={cx('p-icon')}>
                    <FontAwesomeIcon className={cx('right-icon','heart')} icon={faHeart} />
                  </p>
                  <p className={cx('p-icon')}>
