    ...
    return (
        <div className={cx('category')}>
           <div className={cx('category-container')}>
            ...
            <div className={cx('category-hiphop')}>
                <div className={cx('hiphop-title')}>
                    <h1>Nổi Bật</h1>
                </div>
                <div className={cx('hiphop-items')}>
                    <div className={cx('hiphop-item')}>
                        <img className={cx('item-img')} src='' alt='' />
                        <span>Nhạc Mới</span>
                    </div>
                    <div className={cx('hiphop-item')}>
                        <img className={cx('item-img')} src='' alt='' />
                        <span>Top 100</span>
                    </div> <div className={cx('hiphop-item')}>
                        <img className={cx('item-img')} src='/public/imgcategory/1.jfif' alt='' />
                        <span>Tình Yêu</span>
                    </div>
                </div>
            </div>
            <div className={cx('category-rb')}>
                <div className={cx('rb-title')}>
                    <h1>Nổi Bật</h1>
                </div>
                <div className={cx('rb-items')}>
                    <div className={cx('rb-item')}>
                        <img className={cx('item-img')} src='' alt='' />
                        <span>Nhạc Mới</span>
                    </div>
                    <div className={cx('rb-item')}>
                        <img className={cx('item-img')} src='' alt='' />
                        <span>Top 100</span>
                    </div> <div className={cx('rb-item')}>
                        <img className={cx('item-img')} src='/public/imgcategory/1.jfif' alt='' />
                        <span>Tình Yêu</span>
                    </div>
                </div>
            </div>
            <div className={cx('category-movie')}>
                ...
                <div className={cx('movie-items')}>
                    ...
                    <div className={cx('movie-item')}>
                        <img className={cx('item-img')} src='' alt='' />
                        <span>Top 100</span>
                    </div> <div className={cx('movie-item')}>
                        <img className={cx('item-img')} src='/public/imgcategory/1.jfif' alt='' />
                        <span>Tình Yêu</span>
                    </div>
                </div>
            </div>
            <div className={cx('category-chilchren')}>
                <div className={cx('chilchren-title')}>
                    <h1>Nổi Bật</h1>
                </div>
                <div className={cx('chilchren-items')}>
                    <div className={cx('chilchren-item')}>
                        <img className={cx('item-img')} src='' alt='' />
                        <span>Nhạc Mới</span>
                    </div>
                    <div className={cx('chilchren-item')}>
                        <img className={cx('item-img')} src='' alt='' />
                        <span>Top 100</span>
                    </div> <div className={cx('chilchren-item')}>
                        <img className={cx('item-img')} src='/public/imgcategory/1.jfif' alt='' />
                        <span>Tình Yêu</span>
                    </div>
                </div>
