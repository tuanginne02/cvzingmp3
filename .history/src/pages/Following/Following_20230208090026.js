        ...
        <div className={cx('nation-top')}>
          <div className={cx('nation-top-items')}>
            <div
              ...
              style={{ display: changeShowPageVn ? 'block' : 'none' }}
            >
              <span>Việt Nam</span>
            </div>
            <div
              ...
              style={{ display: changeShowPageUsk ? 'block' : 'none' }}
            >
              <span>US-UK</span>
            </div>
            <div
              ...
              style={{ display: changeShowPageKp ? 'block' : 'none' }}
            >
              <span>K-POP</span>
            </div>
            <div
              ...
              style={{ display: changeShowPageCp ? 'block' : 'none' }}
            >
              <span>Hoa Ngữ</span>
            </div>
            <div
              ...
              style={{ display: changeShowPageMainfeed ? 'block' : 'none' }}
            >
              <span>Nổi Bật</span>
            </div>
          </div>
