  ...
  return (
    <div className={cx('following')}>
      <div className={cx('following-container')}>
        ...
        <FollowingUSK style={{display: changeShowPage ? 'no' : 'none' }}/>
        <FollowingKp style={{display: changeShowPage ? 'no' : 'none' }}/>
        <FollowingCp style={{display: changeShowPage ? 'no' : 'none' }}/>
        <MainFeed style={{display: changeShowPage ? 'no' : 'none' }}/>
      </div>
    </div>
  );
}
