        ...
        <div className={cx('nation-top')}>
          <div className={cx('nation-top-items')}>
            <div
              ...
              style={{  background-color: changeShowPageVn ? 'block' : 'none' }}
            >
              <span>Việt Nam</span>
            </div>
            <div
              ...
              style={{  background-color: changeShowPageUsk ? 'block' : 'none' }}
            >
              <span>US-UK</span>
            </div>
            <div
              ...
              style={{  background-color: changeShowPageKp ? 'block' : 'none' }}
            >
              <span>K-POP</span>
            </div>
            <div
              ...
              style={{  background-color: changeShowPageCp ? 'block' : 'none' }}
            >
              <span>Hoa Ngữ</span>
            </div>
            <div
              ...
              style={{  background-color: changeShowPageMainfeed ? 'block' : 'none' }}
            >
              <span>Nổi Bật</span>
            </div>
          </div>
