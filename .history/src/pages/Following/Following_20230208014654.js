  ...
  return (
    <div className={cx('following')}>
      <div className={cx('following-container')}>
        ...
        <FollowingVp style={{ display: changeShowPage ? 'block' : 'none' }}></FollowingVp>
        ...
        <FollowingCp style={{ display: changeShowPage ? 'none' : 'block' }}></FollowingCp></FollowingCp>
        <MainFeed style={{ display: changeShowPage ? 'none' : 'block' }}></MainFeed></MainFeed>
      </div>
    </div>
  );
}
