  ...
  return (
    <div className={cx('following')}>
      <div className={cx('following-container')}>
        ...
        <div
          className={cx('fl-vp')}
          style={{ display: changeShowPageVn ? 'block' : 'none', display: changeShowPageUsk ? 'block' : 'none' ,display: changeShowPageKp ? 'none' : 'block' ,display: changeShowPageKp ? 'none' : 'block' ,display: changeShowPageKp ? 'none' : 'block' }}
        >
          <FollowingVp />
        </div>
