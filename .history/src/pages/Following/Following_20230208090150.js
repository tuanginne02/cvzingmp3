        ...
        <div className={cx('nation-top')}>
          <div className={cx('nation-top-items')}>
            <div
              ...
              style={{  backgroundColor: changeShowPageVn ? 'rgb(110, 104, 117)' : 'none' }}
            >
              <span>Việt Nam</span>
            </div>
            <div
              ...
              style={{  backgroundColor: changeShowPageUsk ? 'rgb(110, 104, 117)' : 'none' }}
            >
              <span>US-UK</span>
            </div>
            <div
              ...
              style={{  backgroundColor: changeShowPageKp ? 'rgb(110, 104, 117)' : 'none' }}
            >
              <span>K-POP</span>
            </div>
            <div
              ...
              style={{  backgroundColor: changeShowPageCp ? 'rgb(110, 104, 117)' : 'none' }}
            >
              <span>Hoa Ngữ</span>
            </div>
            <div
              ...
              style={{  backgroundColor: changeShowPageMainfeed ? 'rgb(110, 104, 117)' : 'none' }}
            >
              <span>Nổi Bật</span>
            </div>
          </div>
