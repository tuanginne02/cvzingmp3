  ...
  return (
    <div className={cx('following')}>
      <div className={cx('following-container')}>
        ...
        <FollowingVp style={{display: changeShowPage ? 'block' : 'none' }}/>
        <FollowingUSK style={{display: changeShowPage ? 'block' : 'none' }}/>
        <FollowingKp style={{display: changeShowPage ? 'block' : 'none' }}/>
        <FollowingCp style={{display: changeShowPage ? 'block' : 'none' }}/>
        <MainFeed style={{display: changeShowPage ? 'block' : 'none' }}/>
      </div>
    </div>
  );
}
