    ...
    <div className={cx('following')}>
      <div className={cx('following-container')}>
        ...
        <div className={cx('fl-cp')} style={{ display: changeShowPage ? 'none' : 'block' }}>
          <FollowingCp></FollowingCp>
        </div>
      <div className={cx('fl-mf')}  style={{ display: changeShowPage ? 'none' : 'block' }} >  <MainFeed style={{ display: changeShowPage ? 'none' : 'block' }}></MainFeed></div>
      </div>
    </div>
  );
}
