...
function Following() {
  ...
  const [changeShowPageKp, setChangeShowPageKp] = useState();
  const [changeShowPageUsk, setChangeShowPageUsk] = useState();
  const [changeShowPageCp, setChangeShowPageCp] = useState();
  const [changeShowPageMainfeed, setChangeShowPageMainfeed] = useState();
