        ...
        <div className={cx('nation-top')}>
          <div className={cx('nation-top-items')}>
            <div
              ...
              style={{  backgroundColor: changeShowPageVn ? 'block' : 'none' }}
            >
              <span>Việt Nam</span>
            </div>
            <div
              ...
              style={{  backgroundColor: changeShowPageUsk ? 'block' : 'none' }}
            >
              <span>US-UK</span>
            </div>
            <div
              ...
              style={{  backgroundColor: changeShowPageKp ? 'block' : 'none' }}
            >
              <span>K-POP</span>
            </div>
            <div
              ...
              style={{  backgroundColor: changeShowPageCp ? 'block' : 'none' }}
            >
              <span>Hoa Ngữ</span>
            </div>
            <div
              ...
              style={{  backgroundColor: changeShowPageMainfeed ? 'block' : 'none' }}
            >
              <span>Nổi Bật</span>
            </div>
          </div>
