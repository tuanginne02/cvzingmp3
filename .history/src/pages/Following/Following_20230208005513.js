      ...
      <div className={cx('following-container')}>
        <div className={cx('nation-top')}>
          <div className={cx('nation-top-items')}>
            <NavLink className={cx('nation-top-item')}to={config.routes.following}>
              <span>Việt Nam</span>
            </NavLink>
            <NavLink className={cx('nation-top-item')} to={config.routes.following_Kp}>
              <span>K-POP</span>
            </NavLink>
            <NavLink className={cx('nation-top-item')} to={config.routes.following_usk}>
              <span>US-UK</span>
            </NavLink>
            <NavLink className={cx('nation-top-item')} to={config.routes.following_Cp}>
              <span>Hoa Ngữ</span>
            </NavLink>
            <NavLink className={cx('nation-top-item')} to={config.routes.mainfeed}>
              <span>Nổi Bật</span>
            </NavLink>
          </div>
        </div>
