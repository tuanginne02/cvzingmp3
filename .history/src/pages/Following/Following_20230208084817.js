  ...
  return (
    <div className={cx('following')}>
      <div className={cx('following-container')}>
        ...
        <div
          className={cx('fl-vp')}
          style={{ display: changeShowPageVn ? 'block' : 'none', display: changeShowPageUsk ? 'block' : 'none' ,display: changeShowPageKp ? 'none' : 'block' ,display: changeShowPageCp ? 'none' : 'block' ,display: changeShowPageMainfeed ? 'none' : 'block' }}
        >
          <FollowingVp />
        </div>
