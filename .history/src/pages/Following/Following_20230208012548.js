  ...
  return (
    <div className={cx('following')}>
      <div className={cx('following-container')}>
        ...
        <FollowingUSK style={{display: changeShowPage ? 'none' : 'blobk' }}/>
        <FollowingKp style={{display: changeShowPage ? 'none' : 'none' }}/>
        <FollowingCp style={{display: changeShowPage ? 'none' : 'none' }}/>
        <MainFeed style={{display: changeShowPage ? 'none' : 'none' }}/>
      </div>
    </div>
  );
}
