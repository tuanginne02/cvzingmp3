...
import UpDateVIP from '~/pages/UpDateVIP';
...
const publicRoutes = [
  ...
  { path: config.routes.updateVip, component: UpDateVIP, layout: HeaderOnly },
  { path: config.routes.support, component: Support, layout: HeaderOnly },
];
//Đã Đăng Nhập
const privateRoutes = [{ path: config.routes.profile, component: UserZing }];
